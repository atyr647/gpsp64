...
#define mips_emit_regimm(function, rs, immediate)                             \
  *JIT_PTR(translation_ptr) = (mips_opcode_regimm << 26) |                    \
